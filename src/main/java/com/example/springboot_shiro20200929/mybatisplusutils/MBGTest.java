...
public class MBGTest {
    private static String  packagePath="com.example.springboot_shiro20200929";//包路径
    private static String  tableName="role_authority";//表名
...
//                .setOutputDir("C:\\Users\\EDZ\\Desktop\\生成代码文件") // 生成路径(绝对路径)
        ...
        source.setDbType(DbType.MYSQL)					// 设置数据库类型
                ...
                .setUrl("jdbc:mysql://localhost:3306/wf_shiro?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=Hongkong")	// 数据库地址
